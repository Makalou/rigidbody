...
struct PipelineContext{
    ...
    void record_draw_command(VkCommandBuffer cmd,bool bind_less, bool instancing){
        ...
        if(bind_less){
            ...
            std::for_each(renderingList.begin(),renderingList.end(),[this, &matIDs](MeshRenderingRecord & record){
            ...
            if(instancing){
                ...
                auto mesh_batches =  mesh_batcher(renderingList.begin(),renderingList.end());
                ...
                std::for_each(renderingList.begin(),renderingList.end(),[this,cmd,&matIDs](MeshRenderingRecord & recorder){
            ...
            auto shader_param_batches = shader_param_batcher(renderingList.begin(),renderingList.end());
...
struct SceneStaticMeshesRenderer : public SceneMeshesRenderer{
    ...
    void record_draw_command(VkCommandBuffer cmd){
        std::for_each(pipelineContexts.begin(),pipelineContexts.end(),[this, &cmd](PipelineContext& pipeline){
    ...
    std::vector<Mesh> meshes;
    std::vector<PipelineContext> pipelineContexts;
